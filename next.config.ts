...
const nextConfig: NextConfig = {
  ...
  images: {
    domains: ["picsum.photos", "eu-images.contentstack.com"],
  },
  env: {
    ...
    LOCALSTORAGE_WEBCONFIG_TTL:
      process.env.LOCALSTORAGE_WEBCONFIG_TTL || "86400", // 1 day in seconds
    ...
    CONTENTSTACK_VISUAL_BUILDER_MODE: process.env
